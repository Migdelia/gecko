	...
	switch ($valor) {
		case "Niveis":
			$conteudo.="\n\t\t\t<div id='tab".$chave."' class='tab_content'>";
				...
				$conteudo.="\n\t\t\t\t<input label='Nivel' type='text' name='descricao' size='30' id='descricao' title='Informe o nome do Nível a ser criado' value='' onfocus=\"$('#info_add_nivel').css({'visibility':'visible'});\" onblur=\"$('#info_add_nivel').css({'visibility':'hidden'});\">";
		...
		case "Usuarios":
			$conteudo.="\n\t\t\t<div id='tab".$chave."' class='tab_content'>";
				...
				$conteudo.="\n\t\t\t\t<div class='lbl' id='lbl_usr_nome'>Nome do Usuário:</div>";
				$conteudo.="\n\t\t\t\t<input label='usr_nome' type='text' name='usr_nome' size='40' id='usr_nome' title='Informe o nome do usuário' value='' onfocus=\"$('#info_usr_nome').css({'visibility':'visible'});\" onblur=\"$('#info_usr_nome').css({'visibility':'hidden'});\">";
				$conteudo.="\n\t\t\t\t<label class='txt_info' id='info_usr_nome'>Informe o nome do Usuário</label><br>";

				$conteudo.="\n\t\t\t\t<div class='lbl' id='lbl_usr_login'>Login do Usuário:</div>";
				$conteudo.="\n\t\t\t\t<input label='usr_usuario' type='text' name='usr_usuario' autocomplete='off' size='25' id='usr_usuario' title='Informe o login do usuário' value='' onfocus=\"$('#info_usr_login').css({'visibility':'visible'});\" onblur=\"$('#info_usr_login').css({'visibility':'hidden'});\">";
				$conteudo.="\n\t\t\t\t<label class='txt_info' id='info_login'>Informe o login do Usuário</label><br>";

				$conteudo.="\n\t\t\t\t<div class='lbl' id='lbl_usr_senha'>Senha do Usuário:</div>";
				$conteudo.="\n\t\t\t\t<input label='usr_senha' type='password' name='usr_senha' autocomplete='off' size='25' id='usr_senha' title='Informe a senha do usuário' value='' onfocus=\"$('#info_usr_senha').css({'visibility':'visible'});\" onblur=\"$('#info_usr_senha').css({'visibility':'hidden'});\">";
				$conteudo.="\n\t\t\t\t<label class='txt_info' id='info_usr_senha'>Informe a senha do Usuário</label><br>";

				$conteudo.="\n\t\t\t\t<div class='lbl' id='lbl_usr_email'>Email do Usuário:</div>";
				$conteudo.="\n\t\t\t\t<input label='usr_email' type='text' name='usr_email' autocomplete='off' size='40' id='usr_email' title='Informe o email do usuário' value='' onfocus=\"$('#info_usr_email').css({'visibility':'visible'});\" onblur=\"$('#info_usr_email').css({'visibility':'hidden'});\">";
				$conteudo.="\n\t\t\t\t<label class='txt_info' id='info_usr_email'>Informe o email do Usuário</label><br>";
		...
		case "Lotes":
			$conteudo.="\n\t\t\t<div id='tab".$chave."' class='tab_content'>";
				...
				//Sequencia
				$conteudo.="\n\t\t\t\t<div class='lbl' id='lbl_seq'>Numeração de:</div>";
				...
				$conteudo.=$local;
				$conteudo.="\n\t\t\t\t</select>";
				$conteudo.="\n\t\t\t\t<label class='txt_info' id='info_et_local'>Local que receberá o cartão.</label><br>";
