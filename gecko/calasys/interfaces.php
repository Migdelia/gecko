	...
	<script type="text/javascript" charset="utf-8">
		...
		$(document).ready(function() {
			var oTable = $('#example').dataTable( {
				...
				"bProcessing": true,
				"bServerSide": true,
				"sAjaxSource": "functions/server_processing1.php?idc=<?=$_SESSION['campos']?>&idi=<?=base64_encode('id_interface')?>&idt=<?=base64_encode('interface')?>",
				"fnRowCallback": 
...
<body>
	...
	<div id='addregistro'>
    	<a onclick="redireciona();" target="_blank" style="text-decoration:none;">
            ...
            <strong>Agregar Interface</strong>
        </a>
	</div>    
</body>
</html>