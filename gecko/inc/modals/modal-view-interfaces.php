  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5><i class="fa fa-eye"></i> <?php echo _('Interface') ?></h5>
      </div>
      <div class="modal-body">
        <p><strong>Detalles</strong></p>
        
			
		<iframe id="view_int" src="frames/view-interface.php" width="100%"  frameborder="0" scrolling="no" marginheight="0" marginwidth="0" align="middle" height="116px;"></iframe>  
