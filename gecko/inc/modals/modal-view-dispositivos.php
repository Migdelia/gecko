  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5><i class="fa fa-eye"></i> <?php echo _('Dongle') ?></h5>
      </div>
      <div class="modal-body">
        <p><strong>Detalles</strong></p>
        
			
		<iframe id="view_disp" src="frames/view-dispositivo.php" width="100%"  frameborder="0" scrolling="no" marginheight="0" marginwidth="0" align="middle" height="154px;"></iframe>  
