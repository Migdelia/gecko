        ...
        <form class="form-horizontal" id="formEditGab" method="post" action="">
          <div class="row">
            <div class="col-xs-12 col-md-6">
              ...
              <div class="row form-group">
                <label for="input_desc<?php echo $modal_item ?>" class="control-label"><?php echo _('Descripcion Gabinete') ?></label>
                <input type="text" class="form-control" id="input_desc_<?php echo $modal_item ?>" name="input_desc_<?php echo $modal_item ?>" placeholder="<?php echo _('Descripcion Gabinete') ?>" value="">
              </div>
            </div>
