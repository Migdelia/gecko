  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5><i class="fa fa-pencil"></i> Editar <?php echo $modal_item ?></h5>
      </div>
        ...
        <form class="form-horizontal" method="post" action="" target="_parent">
          ...
          <div class="row">
            <div class="col-xs-6 col-md-6">
              ...
              <label for="input_num<?php echo $modal_item ?>" class="control-label"><?php echo _('Código Maquina') ?></label>
              <div class="row form-group">
                <label for="input_num<?php echo $modal_item ?>" class="control-label"><?php echo _('Código Maquina') ?></label>
              ...
              <label for="input_num<?php echo $modal_item ?>" class="control-label"><?php echo _('Juego') ?></label>
              <div class="row form-group">
                <label for="input_num<?php echo $modal_item ?>" class="control-label"><?php echo _('Juego') ?></label>
                <input type="text" class="form-control" id="input_jogo_<?php echo $modal_item ?>" name="input_jogo_<?php echo $modal_item ?>" placeholder="<?php echo _('Juego') ?>" value="<?php echo $res_maq['jogo'] ?>" readonly>
              </div>  
			  ...
			  ?> 
              <br />             
              <label for="input_interface<?php echo $modal_item ?>" class="control-label"><?php echo _('Estatus') ?></label>
              <div class="row form-group">
                <label for="input_interface<?php echo $modal_item ?>" class="control-label"><?php echo _('Estatus') ?></label>
              ...
              <label for="input_obsm<?php echo $modal_item ?>" class="control-label"><?php echo _('Orden de  Lectura') ?></label>
              <div class="row form-group">
                <label for="input_obsm<?php echo $modal_item ?>" class="control-label"><?php echo _('Orden de Lectura') ?></label>
                <input type="text" class="form-control" id="input_ordem_<?php echo $modal_item ?>" name="input_ordem_<?php echo $modal_item ?>" placeholder="<?php echo _('Orden de Lectura') ?>" value="<?php echo $res_maq['ordem_leitura'] ?>">
              </div>               
              ...
              <label for="input_obs<?php echo $modal_item ?>" class="control-label"><?php echo _('Salida Oficial') ?></label>
              <div class="row form-group">
                <label for="input_obs<?php echo $modal_item ?>" class="control-label"><?php echo _('Salida Oficial') ?></label>
                <input type="text" class="form-control" id="input_saida_<?php echo $modal_item ?>" name="input_saida_<?php echo $modal_item ?>" placeholder="<?php echo _('Salida Oficial') ?>" value="0">
              </div>                                                                          
            </div>
            <div class="col-xs-6 col-md-6">
              <div class="row form-group">
