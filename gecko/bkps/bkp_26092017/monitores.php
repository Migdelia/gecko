                      ...
                      <table id="idTabela" class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <td class="center-align">
                              <a id="edit_<?php echo $res_mon['id_monitor'] ?>" href="#" class="btn btn-sm" data-toggle="modal" data-target="#edit-modal-<?php echo $filenameID ?>" onClick="alimentaEdit(this);"><?php echo _('Editar') ?></a>
                              <a id="ver_<?php echo $res_mon['id_monitor'] ?>" href="#" class="btn btn-sm" data-toggle="modal" data-target="#view-modal-<?php echo $filenameID ?>" onClick="alimentaView(this);"><?php echo _('Ver') ?></a>
                            </td>
                          </tr>
