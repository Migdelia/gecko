  ...
  <div class="row log-wrap vhAttr valign-wrapper">
    <div class="valign col-xs-12 col-md-6 col-md-offset-3 col-md-8 col-md-offset-2">
      <div class="well login-component sombra-cuadrada">
        <form id="formLogin" class="form-horizontal" action="atualizainfo.php" method="post" onkeyup="return enter();">
            ...
            <input type="hidden" id="xx" name="xx" value="<?php echo $id_disp; ?>"  />
            <input type="hidden" id="yy" name="yy" value="<?php echo $entrada; ?>"  />
            <input type="hidden" id="zz" name="zz" value="<?php echo $saida; ?>"  />            
        </form>
      </div>
    </div>
		...
		$.ajax(
		{
			...
			success: function(html)
			{
				...
				else if(html == 2)
				{
					...
					{
						location.href = 'atualizainfo.php?xx='+idDisp+'&yy='+ent+'&yy='+sai;
					}				
				}
