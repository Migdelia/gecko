...
{
	$whr = " fechamento.id_login = " . $_SESSION['id_login'];
}
						...
						?>
                              <tr>
                                ...
                                <td class="right-align">
                                  ...
                                  <a target="_blank" href="ver-informe-cierre.php?id=<?php echo $res_fechamento['id_fechamento']; ?>" class="btn btn-default" role="button" style="color: white"><?php echo _('Ver') ?></a>
                                </td>
                              </tr>                        
                        <?php							
							}
