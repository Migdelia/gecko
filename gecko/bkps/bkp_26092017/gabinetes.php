                      ...
                      <table id="idTabela" class="table table-striped table-hover">
                        <thead>
                          <tr>
                            ...
                            <th class="center-align">
                              <a href="#"><?php echo _('Descricion') ?></a>
                            </th>
                            <th class="center-align">
                        ...
                        <tbody>
                            ...
                            <td class="right-align">
                              <a id="edit_<?php echo $res_gab['id_tipo_maquina'] ?>" href="#" class="btn btn-sm" data-toggle="modal" data-target="#edit-modal-<?php echo $filenameID ?>" onClick="alimentaEdit(this);"><?php echo _('Editar') ?></a>
                              <a id="ver_<?php echo $res_gab['id_tipo_maquina'] ?>" href="#" class="btn btn-sm" data-toggle="modal" data-target="#view-modal-<?php echo $filenameID ?>" onClick="alimentaView(this);"><?php echo _('Ver') ?></a>
                            </td>
                          </tr>
