                  ...
                  <div class="panel-body">
                    <div class="table-responsive">
                      <table id="datatable" class="table table-striped table-hover">
                        <thead>
                          <tr>
                            <th><?php echo _('Id caja') ?></th>
                            <th><?php echo _('Nombre') ?></th>
                            <th><?php echo _('Fecha Apertura') ?></th>
                            <th><?php echo _('Fecha facturado') ?></th>
                            <th><?php echo _('Entradas') ?></th>
                            <th><?php echo _('Salidas') ?></th>
                            <th><?php echo _('Pagos') ?></th>
                            <th><?php echo _('Cierre') ?></th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
