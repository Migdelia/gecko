          ...
          <div class="row">
            <div class="col-xs-12 col-md-6">
              <div class="row form-group">
                <label><?php echo _('ID de la Máquina') ?></label>
