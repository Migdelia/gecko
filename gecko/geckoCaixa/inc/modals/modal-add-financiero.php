          ...
          <div class="row">
            <div class="col-xs-12 col-md-6">
              <div class="row form-group">
                ...
                <input type="text" class="form-control" id="input_name<?php echo $modal_item ?>" placeholder="<?php echo _('Nombre de ') . $modal_item ?>" value="">
              </div>
              <div class="row form-group">
                <label for="input_pass<?php echo $modal_item ?>" class="control-label"><?php echo _('Contraseña de ') . $modal_item ?></label>
                <input type="text" class="form-control" id="input_pass<?php echo $modal_item ?>" placeholder="<?php echo _('Contraseña de ') . $modal_item ?>" value="">
              </div>
              <div class="row form-group">
                <label for="input_mail<?php echo $modal_item ?>" class="control-label"><?php echo _('Email de ') . $modal_item ?></label>
                <input type="text" class="form-control" id="input_mail<?php echo $modal_item ?>" placeholder="<?php echo _('Email de ') . $modal_item ?>" value="">
              </div>
            </div>
            <div class="col-xs-12 col-md-6">
              <div class="row form-group">
                <label for="input_log<?php echo $modal_item ?>" class="control-label"><?php echo _('Login de ') . $modal_item ?></label>
                <input type="text" class="form-control" id="input_log<?php echo $modal_item ?>" placeholder="<?php echo _('Login de ') . $modal_item ?>" value="">
              </div>
              <div class="row form-group">
