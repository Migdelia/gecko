                  ...
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="input-wrap">
                            ...
                            <div class="form-group">
                              <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button id="btn_trocaNome" class="btn btn-primary" type="button" data-toggle="modal" data-target="#edit-name"><?php echo _('Trocar Nome') ?><div class="ripple-container"></div></button>
                                </span>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#edit-mail"><?php echo _('Trocar E-mail') ?><div class="ripple-container"></div></button>
                                </span>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#edit-password"><?php echo _('Trocar Senha') ?><div class="ripple-container"></div></button>
                                </span>
                              </div>
                            </div>
                          </form>
                        ...
                        <!---
                        <div class="col-xs-12">
                          <a href="#" class="btn btn-lg right" ><?php echo _('Salvar Alterações') ?></a>
                        </div>
                        --->
                      </div>
                    </div>
