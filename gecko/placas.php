...
$query_placa=@mysql_query($sql_placas);
$limitRegistros = mysql_num_rows($query_placa);
...
<html>
  ...
  <body class="body innerpages">
    ...
    <?php $file_name = "placas" // ingresar la palabra clave de cada modal ?>
                    ...
                    <form id="formDados" >
                      ...
                      <table id="idTabela" class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <td class="center-align"><?php echo $res_placa['serie'] ?></td>
                            <td class="center-align"><?php echo $res_placa['descricao'] ?></td>
                            
                            
                            <!--- consultar numero de maquina -->
                            
                            
                            
                            <td class="center-align"><?php echo $res_maquina['numero'] ?></td>
                            <td class="center-align">
                              <a id="edit_<?php echo $res_placa['id_placa'] ?>" href="#" class="btn btn-sm" data-toggle="modal" data-target="#edit-modal-<?php echo $filenameID ?>" onClick="alimentaEdit(this);" title="Editar"><i class="fa fa-edit"></i></a>
                              <a id="ver_<?php echo $res_placa['id_placa'] ?>" href="#" class="btn btn-sm" data-toggle="modal" data-target="#view-modal-<?php echo $filenameID ?>" onClick="alimentaView(this);" title="Ver"><i class="fa fa-eye"></i></a>
                            </td>
                          </tr>
...
<script>
	...
	function alimentaView(obj)
	{
		...
		var $iframe = $('#view_placa');
		$iframe.attr('src','frames/view-placas.php?id='+idPlaca[1]);  		
	...
	function alimentaEdit(obj)
	{
		...
		{								
			...
			url: 'functions/consulta_dados_placas.php', // Informo a URL que será pesquisada.
			data: 'id='+idPlaca[1],
