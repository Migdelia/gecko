									...
									?>
                                      <!---
                                        ...
                                        <td class="center-align">
                                          <a <?php echo "id='".$res_inter['id_interface']."'" ?> href="#" class="btn btn-sm" data-toggle="modal" data-target="#edit-modal-<?php echo $filenameID ?>" onClick="alimentaModal(this);"><?php echo _('Editar') ?></a>
