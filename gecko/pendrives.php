                      ...
                      <table id="idTabela" class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <td class="center-align">
                              <a id="edit_<?php echo $res_pen['id_pendrive'] ?>" href="#" class="btn btn-sm" data-toggle="modal" data-target="#edit-modal-<?php echo $filenameID ?>" onClick="alimentaEdit(this);" title="Editar"><i class="fa fa-edit"></i></a>
                              <a id="ver_<?php echo $res_pen['id_pendrive'] ?>" href="#" class="btn btn-sm" data-toggle="modal" data-target="#view-modal-<?php echo $filenameID ?>" onClick="alimentaView(this);" title="Ver"><i class="fa fa-eye"></i></a>
                            </td>
                          </tr>
