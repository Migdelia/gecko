...
$acoes = array('Despesas','Diferencia de Maquina','Leitura','Fechamento');	
	...
	switch ($valor) {
		...
		case "Despesas":
			...
			$conteudo.="\n\t\t\t<div id='tab".$chave."' class='tab_content'>";
				...
				//onde sera adicionada a despesa
				$conteudo.="\n\t\t\t\t<br /><div class='lbl' id='lbl_lf'>Tipo:</div>";
				$conteudo.="\n\t\t\t\t<select name='tp_lf' id='tp_lf'  style='width:130px;' onfocus=\"$('#info_tp_lf').css({'visibility':'visible'});\" onblur=\"$('#info_tp_lf').css({'visibility':'hidden'});\">";
				$conteudo.="\n\t\t\t\t\t<option value='1'>Leitura</option>";
				$conteudo.="\n\t\t\t\t\t<option value='2'>Fechamento</option>";			
				$conteudo.="\n\t\t\t\t</select>";
				$conteudo.="\n\t\t\t\t<label class='txt_info' id='info_tp_lf'>Leitura ou Fechamento.</label><br>";					
				
				

				//Numero do fechamento / leitura.
				$conteudo.="\n\t\t\t\t<div class='lbl' id='lbl_num_lf'>Numero:</div>";
				$conteudo.="\n\t\t\t\t<input label='Leitura' type='text' name='num_lf' size='7' id='num_lf' title='Informe o numero da leitura/fechamento' value='' onfocus=\"$('#info_num_lf').css({'visibility':'visible'});\" onblur=\"$('#info_num_lf').css({'visibility':'hidden'});\">";
				$conteudo.="\n\t\t\t\t<label class='txt_info' id='info_num_lf'>Numero Leitura/Fechamento</label><br>";


				//tipo de documento
				$conteudo.="\n\t\t\t\t<div class='lbl' id='lbl_tp_doc'>Documento:</div>";
				$conteudo.="\n\t\t\t\t<select name='tp_doc' id='tp_doc'  style='width:130px;' onfocus=\"$('#info_lc_ope').css({'visibility':'visible'});\" onblur=\"$('#info_lc_ope').css({'visibility':'hidden'});\">";
				$conteudo.="\n\t\t\t\t\t<option value='1'>Fatura</option>";
				$conteudo.="\n\t\t\t\t\t<option value='2'>Boleta</option>";
				$conteudo.="\n\t\t\t\t\t<option value='3'>Vale</option>";				
				$conteudo.="\n\t\t\t\t</select>";
				$conteudo.="\n\t\t\t\t<label class='txt_info' id='info_tp_doct'>Tipo de documento.</label><br>";					
				
				
				//Numero do documento.
				$conteudo.="\n\t\t\t\t<div class='lbl' id='lbl_num_doc'>Numero Documento:</div>";
				$conteudo.="\n\t\t\t\t<input label='Leitura' type='text' name='num_doc' size='7' id='num_doc' title='Informe o numero do documento' value='' onfocus=\"$('#info_num_doc').css({'visibility':'visible'});\" onblur=\"$('#info_num_doc').css({'visibility':'hidden'});\">";
				$conteudo.="\n\t\t\t\t<label class='txt_info' id='info_num_doc'>Numero documento</label><br>";				
				
				
				//centro de costo
				$conteudo.="\n\t\t\t\t<div class='lbl' id='lbl_centro_ct'>Centro de custo:</div>";
				$conteudo.="\n\t\t\t\t<select name='centro_ct' id='centro_ct'  style='width:130px;' onfocus=\"$('#info_centro_ct').css({'visibility':'visible'});\" onblur=\"$('#info_centro_ct').css({'visibility':'hidden'});\">";
				...
				$conteudo.="\n\t\t\t\t</select>";
				$conteudo.="\n\t\t\t\t<label class='txt_info' id='info_centro_ct'>Centro de custo.</label><br>";					
						
				//valor despesa		
				$conteudo.="\n\t\t\t\t<div class='lbl' id='lbl_vl_desp'>valor:</div>";
				$conteudo.="\n\t\t\t\t<input label='Leitura' type='text' name='vl_desp' size='7' id='vl_desp' title='Informe o numero da Leitura' value='' onfocus=\"$('#info_vl_desp').css({'visibility':'visible'});\" onblur=\"$('#info_vl_desp').css({'visibility':'hidden'});\">";
				$conteudo.="\n\t\t\t\t<label class='txt_info' id='info_vl_desp'>Valor Despesa</label><br>";
				
				//descricao despesa
				$conteudo.="\n\t\t\t\t<div class='lbl' id='lbl_desc_desp'>Descricao:</div>";
				$conteudo.="\n\t\t\t\t<input label='Leitura' type='text' name='desc_desp' size='25' id='desc_desp' title='Informe o numero da Leitura' value='' onfocus=\"$('#info_desc_desp').css({'visibility':'visible'});\" onblur=\"$('#info_desc_desp').css({'visibility':'hidden'});\">";
				$conteudo.="\n\t\t\t\t<label class='txt_info' id='info_desc_desp'>Descricao Despesa.</label><br>";												
				
				//botao de inserir
				$conteudo.="\n\t\t\t\t<br><br><button id='btn_ins_desp' type='button' class='bt-enviar' style='margin-left:50px;'>Inserir</button><br />";					
				...
				{
					$whr = " WHERE id_login = ".$_SESSION['id_login']." OR id_gerente = " . $_SESSION['id_login'];
				}
				...
				*/
				...
				if($id_leit != '')
				{
					...
					if( ($_SESSION['usr_nivel']==8))
					{
						$wh .= " AND leitura.id_login = ".$_SESSION['id_login']." OR id_gerente = " . $_SESSION['id_login'];
					}					
					
				}
				else if($id_ope != 0)
				{
					$wh .= " AND leitura.id_login = " . $id_ope . " OR id_gerente = " . $id_ope;
				...
				$wh .= " ORDER BY data DESC LIMIT 100";
			...
			$conteudo.="\n\t\t\t<div id='tab".$chave."' class='tab_content'>";
				...
				*/
				...
				if($id_fecha != '')
				{
					...
					if( ($_SESSION['usr_nivel']==8))
					{
						$wh .= " AND fechamento.id_login = ".$_SESSION['id_login']." OR id_gerente = " . $_SESSION['id_login'];
					}						
				}
				else if($id_ope != 0)
				{
					$wh .= " AND local.id_login = " . $id_ope . " OR id_gerente = " . $id_ope;
					//verifica se eh master
					if( ($_SESSION['usr_nivel']==8))
					{
						$wh .= " AND fechamento.id_login = ".$_SESSION['id_login']." OR id_gerente = " . $_SESSION['id_login'];
...
<head>
	...
	<script type="text/javascript" language="javascript">
		...
		$(document).ready(function() {
			...
			//inseri despesa.
			$("#btn_ins_desp").click(function(event){
				var cc = $('#centro_ct').attr("value");
				var vl = $('#vl_desp').attr("value");
				var dc = $('#desc_desp').attr("value");
				var td = $('#tp_doc').attr("value");
				var nd = $('#num_doc').attr("value");
				var numero_lf = $('#num_lf').attr("value");
				var tp_lf = $('#tp_lf').attr("value");
				var op = "suporte";
				var vf = vl;
				...
				jQuery.ajax(
				{
					...
					data: 'cent_cust='+cc+'&valor='+vl+'&descricao='+dc+'&tipo_doc='+td+'&numero_doc='+nd+'&oper='+op+'&tp_lf='+tp_lf+'&num_lf='+numero_lf,
