<?php
	...
	*/
...

	{
		...
		// verifica se é operador para nao trazer resultados de outros operadores
...

	{
...

		{
			...
			if ( $aColumns[$i] == "Data" ) {
				...
				//Verifica se o Local é Calabaza (10) para liberar o excluir

				if ( strstr($_SESSION['reg_acesso'],"'10'") ) {

					/* Special output formatting for 'Excluir' */
