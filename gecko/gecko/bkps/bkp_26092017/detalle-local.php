...
//verificar se é local integrado.
$flagLocalIntegrado = 0;
//
$sql_locIntegrado = "
	SELECT
		id_local_integrado
...
$query_locIntegrado=@mysql_query($sql_locIntegrado);
$flagLocalIntegrado = mysql_num_rows($query_locIntegrado);
//$result_locIntegrado=@mysql_fetch_assoc($query_locIntegrado);
          ...
          <div class="row">
            <div class="col-xs-12 col-lg-6">
              <h3 class="main-title">
                ...
                <?php
                	echo _('<strong>Nueva Lectura: </strong>');
					echo "(".$result_loc['nome'].")";
					echo '<strong> - Fecha Referencia: </strong>';
					
					$dataFecha = explode(',', $dataRef);
            ...
            <div class="col-xs-12 col-lg-6">
              <?php include("inc/buttons-lectura.php"); // btns paneles ?>
              <?php include("inc/modals/modal-actions-lectura.php"); // modal para agregar contenido ?>
            </div>
          </div>
                ...
                <div class="panel-heading">
                  <div class="input-wrap">
                    ...
                    <div class="btn-group white-btn">
                      <?php 
					  	include("inc/dropdown-actions-lectura.php");
						  ?>
                    </div>                                      
                  </div>                 
                </div>
                      ...
                      <table id="tabelaLeitura" class="table table-striped table-hover">
						...
						?>
                                <tr id="ln_<?php echo $result_maq['id_maquina']; if($rst_dadosAtuais['lastUpdate'] <> ''){?>" title="Actualizado: <?php echo date("d-m-Y H:i", strtotime($rst_dadosAtuais['lastUpdate']));} ?>">
                                	<td class="left-align"><strong><?php echo $result_maq['numero'] . "</strong><br><img src='images/".$result_maq['id_jogo'].".png' width='40px;' >"; ?></td>
                                	<td>
                                    	<?php
											...
											{
												echo "<input id='".$result_maq['id_maquina']."_ent' name='".$result_maq['id_maquina']."_ent' type='text'  placeholder='$' size='1' onKeyUp='editaBruto(this);' onBlur='calculaBruto(this);' value='0' style='font-size:12px;'>";													
											}											
										?>
                                		<br>
                                        ...
                                        <span id="<?php echo $result_maq['id_maquina']?>_ent_ant">
											<?php echo number_format($result_maq['valor_entrada_total'],0,"","."); ?>
                                        </span>
                                	</td>
                                	...
                                	<td>
                                    	<?php
											...
											{
												echo "<input id='".$result_maq['id_maquina']."_sai' name='".$result_maq['id_maquina']."_sai' type='text'  placeholder='$' size='1' onKeyUp='editaPremio(this);' onBlur='calculaPremio(this);' value='0' style='font-size:12px;'>";													
											}
										?>                                    
                                        <br>
                                		...
                                		<span id="<?php echo $result_maq['id_maquina']?>_sai_ant"><?php echo number_format($result_maq['valor_saida_total'],0,"","."); ?></span>
                                	</td>
                                	<td class="center-align">
                                    	$ <span id="<?php echo $result_maq['id_maquina']?>_premio">
											...
											<?php 
												...
												echo number_format($premioInd,0,"","."); 
                                    	...
                                    	<strong>
                                            ...
                                            <span id="<?php echo $result_maq['id_maquina']?>_tot_maq">
												...
												//verificar o tipo de local
													...
													echo number_format($totMaqInd,0,"",".");																																						
												?>
                                            </span>
                                        </strong></td>
                                </tr>                        
						...
						<?php
							//soma totais.
							$totalEntrada = $totalEntrada + $brutoInd;
							$totalSaida = $totalSaida + $premioInd;
							$totalSubTotal = $totalSubTotal + $subInd;
							$totalLocal = $totalLocal + $pctMaqInd;
							$totalFinal = $totalFinal + $totMaqInd;							
				...
				--->
                    ...
                    <table class="table  table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="left-align"></td>
                          <td class="right-align">
                            <a href="#" class="btn btn-raised btn-sm" data-toggle="modal" data-target="#edit-modal-diferenca"><?php echo _('Editar'); ?></a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="table-responsive">
                    <table class="table  table-hover">
                      ...
                      <tbody>
                        <tr>
                          <!--- <td><span id="obs">Comentarios!!</span></td> --->
...
<script>
	...
	$('#confAcao').click( function ()
	{
		...
		while (cont< "<?=$NumeroLinhas?>")
		{
			...
			var vl_obj_ent = $("#" + obj_ent + "").text();
			
			//pega o valor de saida
			var obj_sai = id_obj + "_premio";
			var vl_obj_sai = $("#" + obj_sai + "").text();
		...
		//
		$("#confAcao").attr('disabled','disabled');
