									...
									?>
                                      <!---
                                        ...
                                        <td class="center-align">
                                          ...
                                          <a href="#" id="ver_<?php echo $res_dongle['MachineId'] ?>" class="btn btn-sm" data-toggle="modal" data-target="#view-modal-<?php echo $filenameID ?>" onClick="alimentaView(this);"><?php echo _('Ver') ?></a>
                                        </td>
                                      </tr>                                    
									<?php						
								}                        
