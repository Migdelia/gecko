                      ...
                      <table id="idTabela" class="table table-striped table-hover">
                        <thead>
                          <tr>
                            ...
                            <th class="left-align">
                              <a><?php echo _('Nível') ?></a>
                            </th>
                            <th class="left-align">
                              <a><?php echo _('Status') ?></a>
                            </th>                                               
									...
									?>
                                      <!---
                                        ...
                                        <td class="right-align" colspan="2">
                                          <a <?php echo "id=edit_'".$res_usr['id_login']."'" ?> class="btn btn-sm" data-toggle="modal" data-target="#edit-modal-<?php echo $filenameID ?>" onClick="modalEdit(this);">
										  	<?php echo _('Editar') ?>
                                           </a>
                                          <a <?php echo "id=ver_'".$res_usr['id_login']."'" ?> class="btn btn-sm" data-toggle="modal" data-target="#view-modal-<?php echo $filenameID ?>" onClick="modalVer(this);">
										  	<?php echo _('Ver') ?>
                                           </a>
                                        </td>
                                      </tr>                                    
