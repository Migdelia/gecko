                        	...
                        	<?php
								while($res_jg=@mysql_fetch_assoc($query_jg)) 
								{
									...
									?>
                                        ...
                                        <a <?php echo "id='".$res_jg['id_jogo']."'" ?> href="#" class="btn btn-sm" data-toggle="modal" data-target="#edit-modal-<?php echo $filenameID ?>" onClick="alimentaModal(this);"><?php echo _('Editar') ?></a>
                                        <a id="ver_<?php echo $res_jg['id_jogo'] ?>" href="#" class="btn btn-sm" data-toggle="modal" data-target="#view-modal-<?php echo $filenameID ?>" onClick="alimentaView(this);"><?php echo _('Ver') ?></a>
                                        </td>
                                      </tr>                                    
									<?php						
								}                        
