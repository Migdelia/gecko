		...
		<div class="col-xs-12">
			<div class="panel validateScreen">
				<div class="panel-heading">
					<i class="fa fa-check-circle-o"></i> <?php echo _('Validação') ?>
				</div>
				<div class="panel-body">
					<div class="validate row">
						<div class="col-xs-12 col-sm-2">
							<a href="#" class="btn red darken-1 btn-md btn-block"><?php echo _('Senha1') ?></a>
						</div>
					...
					<div class="validate row">
						<div class="col-xs-12 col-sm-2">
							<a href="#" class="btn teal darken-1 btn-md btn-block"><?php echo _('Senha2') ?></a>
						</div>
						<div class="col-xs-12 col-sm-10">
							<form id="validation" class="val-input">
                        <div class="form-group">
					...
					<div class="validate row">
						<div class="col-xs-12 col-sm-2">
							<a href="#" class="btn blue darken-1 btn-md btn-block"><?php echo _('Senha3') ?></a>
						</div>
						<div class="col-xs-12 col-sm-10">
							<form id="validation" class="val-input">
                        <div class="form-group">
