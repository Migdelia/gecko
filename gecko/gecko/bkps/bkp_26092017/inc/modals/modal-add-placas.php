    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal" method="post" action="">
          ...
          <div class="row form-group">
            <div class="col-xs-12">
                <a id="btnAddPlaca" href="#" class="btn btn-sm btn-raised col-xs-12 col-md-5 right" data-toggle="modal" data-target="#confirm-modal">
...
<script>
	...
	{
		//
		var seriePlaca = $('#add_serie_Placa').val();
		var maqPlaca = $('#hd_maquina_Placa').val();	
		var modPlaca = $('#hd_modelo_Placa').val();								

		// 
		jQuery.ajax(
		{
			type: "POST", // Defino o método de envio POST / GET
			url: 'functions/addPlaca.php', // Informo a URL que será pesquisada.
			data: 'add_serie_Placa='+seriePlaca+'&hd_maquina_Placa='+maqPlaca+'&hd_modelo_Placa='+modPlaca,
			success: function(html)
			{
				//alert(html);
				if(html == true)
				{
					$('#add-modal-Placas').fadeOut("slow");
