  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5><?php echo _('Estas seguro que quiere crear esta lectura?') ?></h5>
      </div>
      <div class="modal-body">
        <p>
        	<strong><span id="tpAcao">Local:</strong> <?php echo $result_loc['nome'];?></span>
            <br />
        	<strong><span id="tpAcao">Fecha referencia:</strong> <?php $dataFecha = explode(',', $dataRef); echo $dataFecha[0];?></span>
        </p>
