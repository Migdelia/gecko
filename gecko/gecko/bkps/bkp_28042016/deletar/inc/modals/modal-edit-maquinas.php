        ...
        <form class="form-horizontal">
          <div class="row">
            ...
            <div class="col-xs-12 col-md-6">
              ...
              <div class="row form-group">
                <label for="input_resp<?php echo $modal_item ?>" class="control-label"><?php echo _('Responsable') ?></label>
                <input type="text" class="form-control" id="input_resp<?php echo $modal_item ?>" placeholder="<?php echo _('Responsable') ?>" value="">
              </div>
              <div class="row form-group">
                <label for="input_obsm<?php echo $modal_item ?>" class="control-label"><?php echo _('Observaciones de máquina') ?></label>
