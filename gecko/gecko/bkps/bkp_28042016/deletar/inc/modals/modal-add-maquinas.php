          ...
          <div class="row">
            <div class="col-xs-12 col-md-6">
              <div class="row form-group">
                <h6><?php echo _('Crear Nueva Máquina') ?></h6>
              </div>
              <div class="row form-group">
              ...
              <div class="row form-group">
                <label for="input_mod<?php echo $modal_item ?>" class="control-label"><?php echo _('Modelo máquina') ?></label>
              ...
              <div class="row form-group">
                <label for="input_inter<?php echo $modal_item ?>" class="control-label"><?php echo _('Interface') ?></label>
                <a href="#" data-target="#" data-toggle="dropdown" aria-expanded="false" id="input_inter<?php echo $modal_item ?>" class="btn dropdown-btn"><?php echo _('Interface') ?><div class="ripple-container"></div></a>
                <a href="#" data-target="#" class="btn dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><span class="caret"></span><div class="ripple-container"></div></a>
                <ul class="dropdown-menu">
                  <li>
                    <a href="#" class="mass-act"><?php echo _('Action 1') ?></a>
            ...
            <div class="col-xs-12 col-md-6">
              ...
              <div class="row form-group">
                <label for="input_espec<?php echo $modal_item ?>" class="control-label"><?php echo _('Máquina % especial') ?></label>
              ...
              <div class="row form-group">
                <label for="input_obs<?php echo $modal_item ?>" class="control-label"><?php echo _('Observaciones de máquina') ?></label>
