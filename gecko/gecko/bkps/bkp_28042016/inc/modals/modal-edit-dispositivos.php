          ...
          <div class="row">
            <div class="col-xs-12 col-md-6">
              <div class="row form-group">
                ...
                <input type="text" class="form-control" id="input_id_<?php echo $modal_item ?>" placeholder="<?php echo _('ID de la Máquina') ?>" value="0" readonly="readonly">
              </div>
              <div class="row form-group">
                <label for="input_expdate<?php echo $modal_item ?>" class="control-label"><?php echo _('Fecha de Expiración') ?></label>
                <input type="text" class="form-control" id="input_expdate_<?php echo $modal_item ?>" placeholder="<?php echo _('Fecha de Expiración') ?>" value="" readonly="readonly">
              </div>
              <div class="row form-group">
            ...
            <div class="col-xs-12 col-md-6">
              <div class="row form-group">
                ...
                <input type="text" class="form-control" id="input_game_<?php echo $modal_item ?>" placeholder="<?php echo _('ID del juego') ?>" value="" readonly="readonly">
              </div>
              <div class="row form-group">
                <label for="input_ultact<?php echo $modal_item ?>" class="control-label"><?php echo _('Última Actualización') ?></label>
                <input type="text" class="form-control" id="input_ultact_<?php echo $modal_item ?>" placeholder="<?php echo _('Última Actualización') ?>" value="" readonly="readonly">
              </div>
              <div class="row form-group">
                ...
                <?php 
					...
					while($res_users=@mysql_fetch_assoc($query_users)) 
					{						
				?>
                      <li>
                        <a href="#" class="mass-act" id="user_<?php echo _( $res_users['id_login'] ) ?>" onclick="atribuiUser(this);"><?php echo _( $res_users['nome'] ) ?></a>
                      </li>
                <?php
					}
				?>
