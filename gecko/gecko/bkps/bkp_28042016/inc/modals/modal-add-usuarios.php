  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5><?php echo _('Inserir ') . $modal_item ?></h5>
      </div>
      <div class="modal-body">
        <p>Insira os dados do novo usuario que deseja cadastrar.</p>
          ...
          <div class="row">
            <div class="col-xs-12 col-md-6">
              <div id="div_name<?php echo $modal_item ?>" class="row form-group">
                <label for="input_name<?php echo $modal_item ?>" class="control-label"><?php echo _('Nome de ') . $modal_item ?></label>
                <input type="text" class="form-control" id="input_name<?php echo $modal_item ?>" name="input_name<?php echo $modal_item ?>" placeholder="<?php echo _('Nome de ') . $modal_item ?>" value="">
              </div>
              <div id="div_senha<?php echo $modal_item ?>" class="row form-group">
                <label for="input_pass<?php echo $modal_item ?>" class="control-label"><?php echo _('Senha de ') . $modal_item ?></label>
                <input type="password" class="form-control" id="input_pass<?php echo $modal_item ?>" name="input_pass<?php echo $modal_item ?>" placeholder="<?php echo _('Senha de ') . $modal_item ?>" value="">
              </div>
            ...
            <div class="col-xs-12 col-md-6">
              ...
              <div class="row form-group">
                <label for="input_nivel<?php echo $modal_item ?>" class="control-label"><?php echo _('Nível de ') . $modal_item ?></label>
                <a href="#" data-target="#" data-toggle="dropdown" aria-expanded="false" id="input_nivel<?php echo $modal_item ?>" name="input_nivel<?php echo $modal_item ?>" class="btn dropdown-btn"><?php echo _('Nível de ') . $modal_item ?><div class="ripple-container"></div></a>
