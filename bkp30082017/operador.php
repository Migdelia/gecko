...
$sql_usr = "
	SELECT
		vw_operador.id_login,
		vw_operador.Nome,
		vw_operador.Usuario,
		vw_operador.Email,
		vw_operador.excluido
	FROM
		vw_operador
	";
	...
	<script type="text/javascript" charset="utf-8">
		...
		$(document).ready(function() {
			var oTable = $('#example').dataTable( {
				...
				"bProcessing": true,
				"bServerSide": true,
				"sAjaxSource": "functions/server_processing1.php?idc=<?=$_SESSION['campos']?>&idi=<?=base64_encode('id_login')?>&idt=<?=base64_encode('vw_operador')?>",
				"fnRowCallback": 
