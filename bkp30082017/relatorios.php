...
//Campos a serem exibidos na personalização de relatorios (vw_relatorios)
	...
	<script type="text/javascript" language="javascript" charset="utf-8">
		...
		$(function(){	
			...
			<?
				...
				//Monta a rotina de formatação dos campos de criterios
		...
		var alterar_favorito=function(v){
			...
			if (confirm('Atenção!\n\nDeseja alterar a configuração de favoritos para este relatório?')) {
