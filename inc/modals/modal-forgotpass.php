      ...
      <div class="modal-body">
        <form class="form-horizontal" action="" method="post">
            ...
            <div class="form-group">
              <label for="inputEmail" class="col-md-2 control-label"><?php echo _('Inserte su correo para enviar la nueva contraseña!') ?></label>
              <div class="col-xs-12">
            ...
            <div class="form-group">
              <div class="col-xs-12">
                <button type="button" id="btnEnviaSenha" class="btn btn-lg btn-raised right"><?php echo _('Enviar Clave') ?></button>
              </div>
            </div>
        </form>
      </div>
