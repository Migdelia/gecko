    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal">
          <div class="row">
            <div class="col-xs-12 col-md-6">
              <div class="row form-group">
                <label for="input_name<?php echo $modal_item ?>" class="control-label"><?php echo _('Serie') ?></label>
			  ...
			  <div class="row form-group">
				...
				?>
                      <li>
                        <a class="mass-act" id="maquina_<?php echo $modal_item ?>" onclick="atribuiValorIns(this);"><?php echo _($res_maquinas['numero']) ?></a>
                      </li>                
                <?php
					}								
				?>
            ...
            <div class="col-xs-12 col-md-6">
			  <div class="row form-group">
				...
				?>
                          <li>
                            <a class="mass-act" id="modelo_<?php echo $modal_item ?>" onclick="atribuiValorIns(this);"><?php echo _($res_modelos['descricao']) ?></a>
                          </li>                
                <?php
					}								
				?>             
          ...
          <div class="row form-group">
            <div class="col-xs-12">
                <a id="btnAddPen" href="#" class="btn btn-sm btn-raised col-xs-12 col-md-5 right" data-toggle="modal" data-target="#confirm-modal">
...
<script>
	...
	//
	$('#btnAddPen').click(function()
	{
		//
		var seriePen = $('#input_serie_Pendrive').val();
		var maqPen = $('#hd_maquina_Pendrive').val();	
		var modPen = $('#hd_modelo_Pendrive').val();							

		// 
		jQuery.ajax(
		{
			type: "POST", // Defino o método de envio POST / GET
			url: 'functions/addPendrive.php', // Informo a URL que será pesquisada.
			data: 'input_serie_Pendrive='+seriePen+'&hd_maquina_Pendrive='+maqPen+'&hd_modelo_Pendrive='+modPen,
			success: function(html)
			{
				//alert(html);
				if(html == true)
				{
					$('#add-modal-Pendrives').fadeOut("slow");
