  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5><i class="fa fa-calendar"></i> <?php echo _('Elegir periodo de ') . $modal_item ?></h5>
      </div>
          ...
          <div class="row">
          	<div class="col-xs-12 col-md-6">
                <div class="row">              
                  ...
                  <input type='text' id='dataInicio' name='dataInicio' size='23' placeholder="dd-mm-aaaa" value="<?php echo date("d-m-Y", strtotime($result_leit_ant['data'])); ?>" readonly>
                </div>          
            </div>
          	<div class="col-xs-12 col-md-6">
                <div class="row">
                  <label for="tags">Fecha final</label>
                  <input type='text' id='dataFinal' name='dataFinal' size='23' placeholder="dd-mm-aaaa" value="<?php echo date("d-m-Y", strtotime($result_id_local['data'])); ?>" readonly>
                </div>             
            </div>
            <div class="col-xs-12">
...
<script type="text/javascript">
	...
	$("#btnRecarregar").click( function (){
		...
		//
		location="ver-informe-lectura.php?id="+<?php echo $id_assoc;?>+"&dI="+dataInicio+"&dF="+dataFinal;
	});
