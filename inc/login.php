      ...
      <div class="well login-component sombra-cuadrada">
        <form id="formLogin" class="form-horizontal" action="home.php" method="post" onkeyup="return enter();">
            ...
            <div id="divUsuario" class="form-group"> <!--- <div class="form-group has-error"> -->
              <label for="inputEmail" class="col-md-2 control-label"><?php echo _('Usuario') ?></label>
              <div class="col-xs-12">
                <input type="text" class="form-control" id="inputEmail" name="inputEmail" value="" placeholder="<?php echo _('Usuario') ?>">
              </div>
            </div>
            <div id="divSenha" class="form-group">
              <label for="inputPassword" class="col-md-2 control-label"><?php echo _('Clave') ?></label>
              <div class="col-xs-12">
                <input type="password" class="form-control" id="inputPassword" name="inputPassword" placeholder="<?php echo _('Clave') ?>" value="">
              </div>
            </div>
            <div class="form-group">
              <div class="col-xs-12">
                <a href="#" class="forgot" data-toggle="modal" data-target="#forgot-modal"><?php echo _('Olvidó su clave?') ?></a>
              </div>
            </div>
            ...
            <input type="hidden" id="vQr" name="vQr" value="<?php echo $codVer; ?>"  />
        </form>
      </div>
    </div>
		...
		$.ajax(
		{
			...
			success: function(html)
			{
				...
				else if(html == 2)
				{
					...
					{
						location.href = 'validacion.php?s='+codQR+'&v='+codVer;
					}				
				}
