                          ...
                          <tbody>
							...
							while($res_cidades=@mysql_fetch_assoc($query_cidade)) 
							{
                              ...
                              <td class="center-align">
                                <a href="" <?php echo "id='".$res_cidades['id_cidade']."'" ?> class="btn btn-sm" data-toggle="modal" data-target="#edit-modal-<?php echo $filenameID ?>" onClick="alimentaModal(this);" title="Editar"><i class="fa fa-edit"></i></a>
                                <a <?php echo "id=ver_'".$res_cidades['id_cidade']."'" ?> href="#" class="btn btn-sm" data-toggle="modal" data-target="#view-modal-<?php echo $filenameID ?>" onClick="modalVer(this);"title="Ver"><i class="fa fa-eye"></i></a>
                              </td>
                            </tr>
									<?php						
								}                        
