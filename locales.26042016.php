                        ...
                        <table id="idTabela" class="table table-striped table-hover table-condensed">
                          <thead>
                            <tr>
                              ...
                              <th class="left-align sort-asc">
                                <a ><?php echo _('Local') ?></a>
                              </th>
                              <th class="center-align">
                                <a ><?php echo _('Operador') ?></a>
                              </th>
                              <th class="center-align">
                                <a ><?php echo _('Gerente') ?></a>
                              </th>
                              <th class="center-align">
                          ...
                          <tbody>
							...
							while($res_local=@mysql_fetch_assoc($query_local)) 
							{
								if($i<=10)
								{
									echo "<tr id='linha_".$i."' title='".$res_local['endereco']. "+" . $res_local['nome_cidade'] . "' onClick='mudaLocal(this);' >";
								}
								else
								{
									echo "<tr id='linha_".$i."' title='".$res_local['endereco']. "+" . $res_local['nome_cidade'] . "' onClick='mudaLocal(this);' style='display:none;'>";
								}
