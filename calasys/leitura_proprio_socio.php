...
<th style='color:#E17009;'>Total</th>
		...
		while($result_maq=@mysql_fetch_assoc($query_maq)) {
			...
			{*/
				...
				{*/
					...
					$guias_cont.="\n\t\t\t\t\t\t <input label='0' type='text' name='" . $result_maq['id_maquina'] . "_ent' size='13' id='" . $result_maq['id_maquina'] . "_ent' onclick='selCampo(this);' onkeypress='verificaTecla(this);' onblur='calcula(this.id," . $result_maq['id_maquina'] . "," . $result_maq['valor_entrada_total'] . "," . $result_maq['valor_saida_total'] ."," . $pct_maq_soc . ");' title='Informe entrada da maquina' style='text-align:center' value='".number_format($entrada,0,"",".")."'  > <input type='button' id='rep_ent_".$result_maq['id_maquina']."' name='rep_ent_".$result_maq['id_maquina']."' title='".$result_maq['valor_entrada_total']."' value=' = ' onclick='rep_valor(this);' />";				
...

				{
					...
					$guias_cont.="\n\t\t\t\t\t\t <input type='text' name='" . $result_maq['id_maquina'] . "_sai' size='13' id='" . $result_maq['id_maquina'] . "_sai' style='text-align:center' onclick='selCampo(this);' onkeypress='verificaTecla(this);' onBlur='calcula(this.id," . $result_maq['id_maquina'] . "," . $troca_entrada . "," . $troca_saida ."," . $pct_maq_soc . ");' title='".$cont."' value='".number_format($saida,0,"",".")."' label='0' > <input type='button' id='rep_sai_".$result_maq['id_maquina']."' name='rep_sai_".$result_maq['id_maquina']."' title='".$result_maq['valor_saida_total']."' value=' = ' onclick='rep_valor(this);' />";
				...
				{*/
					...
					$guias_cont.="\n\t\t\t\t\t\t <input type='text' name='" . $result_maq['id_maquina'] . "_sai' size='13' id='" . $result_maq['id_maquina'] . "_sai' style='text-align:center' onclick='selCampo(this);' onkeypress='verificaTecla(this);' onBlur='calcula(this.id," . $result_maq['id_maquina'] . "," . $result_maq['valor_entrada_total'] . "," . $result_maq['valor_saida_total'] ."," . $pct_maq_soc . ");' title='".$cont."' value='".number_format($saida,0,"",".")."' label='0' > <input type='button' id='rep_sai_".$result_maq['id_maquina']."' name='rep_sai_".$result_maq['id_maquina']."' title='".$result_maq['valor_saida_total']."' value=' = ' onclick='rep_valor(this);' />";				
	...
	$guias_cont.="\n\t\t\t</table>";
		...
		$guias_cont.="\n\t\t\t\t\t\t<tr bgcolor='#F5F8F9' height='42px;' style='font-weight:bolder' align='center'><th style='color:#E17009;' colspan='2'>Observacao: </th>";
...
/*
		...
		$guias_cont.="\n\t\t\t\t\t\t<tr bgcolor='#F5F8F9' height='44px;' style='font-weight:bolder' align='center'><th style='color:#E17009;' colspan='2'>Detalhes de Deve: </th>";
		...
		$guias_cont.="\n\t\t\t\t\t\t<tr bgcolor='#F5F8F9' height='21px;' style='font-weight:bolder' align='center'><th style='color:#E17009;' colspan='2'>Totalizadores Lan&ccedil;amentos: </th>";
			...
			$guias_cont.="\n\t\t\t\t\t\t\t<font color='red'></font>&nbsp; <input id='comissao' value='0' style='font-family:Tahoma, Verdana, Arial, Helvetica, sans-serif;font-size:10px;font-weight:bolder;text-align:center;background-color:transparent; border:none;' onBlur='total_pagar()'  readonly='readonly' > ";
...
*/
			...
			$guias_cont.="\n\t\t\t\t\t\t\t&nbsp;<input id='totalsocio' value='".number_format($TotPctSocio,0,"",".")."' style='font-family:Tahoma, Verdana, Arial, Helvetica, sans-serif;font-size:10px;font-weight:bolder;text-align:center;background-color:transparent; border:none;' readonly='readonly'  > ";//.number_format($vtot,'2',',','.');
...
<head>
...

	{
...

		{
			...
			tot_por_maq = (tot_por_maq * 20) / 100;
...

			{
				...
				$("#" + totmaq_id).attr("value",0); //total final da maquina
			...
			sub_tot_real = tot_subtot;

			

			tot_subtot = (tot_subtot * 80) / 100;
			...
			var comissao = (sub_tot_real * 5) / 100;
...

	{
		...
		*/
		...
		var tot_pagar = (efetivo - deve - comissao) / 2;
		...
		var parteCala = $('#total_final').attr("value");

		var parteSocio = $('#total_porcentagem').attr("value");
		...
		tot_pagarCala = eval(tot_pagar) + eval(parteCala);

		tot_pagarSocio = eval(tot_pagar) + eval(parteSocio);

			

		tot_pagarCala = tot_pagarCala.formatNumber(2,',','.');

		tot_pagarCala = tot_pagarCala.split(",");			

		tot_pagarCala = tot_pagarCala[0];

		

		tot_pagarSocio = tot_pagarSocio.formatNumber(2,',','.');

		tot_pagarSocio = tot_pagarSocio.split(",");			

		tot_pagarSocio = tot_pagarSocio[0];					



			

		$("#totalapagar").attr("value",tot_pagarCala);

		$("#totalsocio").attr("value",tot_pagarSocio);
	...
	$("#rep_leit").click( function () {
		...
		location="leitura_proprio_socio.php?id="+<?=$id_assoc?>+"&rep=1";
