...
if ( $_GET['ida']==base64_encode('personalizado') ) {
	...
	//Criterio da restriçao de acesso
...
//Caso nao seja personalizado, exibe a opçao de download
...
if ( $_GET['ida']!=base64_encode('personalizado') ) {
	...
	/*$tabela.="\n\t\t\t\t\t\t\t<a id='gerar_xls' href='functions/gera_xls.php?ida=".base64_encode($_GET['ida'])."' onclick=\"alert('ATENÇAO!!!\\n\\nA geraçao do download pode demorar varios minutos.\\nClique e agurade o término do processamento.\\n');\">Download - / ".$report."</a><br />";*/
...
while ( $Dados=mysql_fetch_assoc($query) ) {
	...
	//verifica se é faturamento * Erico 
