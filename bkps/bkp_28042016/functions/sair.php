...
{
	header('Location:'.$dominio.'/index.php?s=' . $senhaQR);
	echo "<script>window.location='index.php?s=" . $senhaQR ."'</script>";
	exit("<a href='index.php?s=" . $senhaQR ."' title='Sair do sistema'><strong><img src='img/proximo.png' title='Sair do sistema' align='absmiddle' border=none alt='Sair do sistema' />Sair do Sistema</strong></a>");
}
