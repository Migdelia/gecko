            ...
            <div class="col-xs-12 col-lg-6">
              <h3 class="main-title">
                ...
                <?php echo _('Informe de Cierre') ?>
                  <a id="teste" onClick="atuRelatorio('column');" href="#" class="btn" style="margin:0 0 0 10px;"><i class="fa fa-signal"></i> <?php echo _('Barra'); ?></a>
                  <a id="teste" onClick="atuRelatorio('pie');" href="#" class="btn" style="margin:0 0 0 10px;"><i class="fa fa-circle"></i> <?php echo _('Pizza'); ?></a>                 
           	 </h3>
            </div>
            <div class="col-xs-12 col-lg-6">
