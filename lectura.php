...
{
	$whr = " AND (vw_leitura_info.id_login = " . $_SESSION['id_login'] . " OR vw_leitura_info.id_admin = " . $_SESSION['id_login'] . " OR vw_leitura_info.id_operador = " . $_SESSION['id_login'] . " OR vw_leitura_info.id_gerente = " . $_SESSION['id_login'] . ")";
}
                  ...
                  <div class="panel-body">
                    ...
                    <form id="formDados" >
                      ...
                      <table id="idTabela" class="table table-striped table-hover">
                        <thead>
                          <tr>
                          	<!--- desabilita check massivo  Erico
