          ...
          <div class="row">
            <div class="col-xs-12 col-md-12">
              <div class="row form-group">
                <label class="control-label"><?php echo _('ID de usuario') ?></label>
                <h5>John Doe</h5>
              </div>
              <div class="row form-group">
                  <label for="input_exclu<?php echo $modal_item ?>" class="control-label"></label>
                  <a href="#" data-target="#" data-toggle="dropdown" aria-expanded="false" id="input_exclu<?php echo $modal_item ?>" class="btn dropdown-btn"><?php echo _('Elija una opción') ?><div class="ripple-container"></div></a>
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="#" class="mass-act"><?php echo _('Habilitar') ?></a>
                    </li>
                    <li class="divider"></li>
                    <li>
                      <a href="#" class="mass-act"><?php echo _('Deshabilitar') ?></a>
                    </li>
                  </ul>
                </div>
            </div>
