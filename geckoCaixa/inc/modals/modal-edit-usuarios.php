    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal">
          <div class="row">
            <div class="col-xs-12 col-md-6">
              <div class="row form-group">
                ...
                <input type="text" class="form-control" id="input_id<?php echo $modal_item ?>" placeholder="<?php echo _('ID de usuario') ?>" value="Lorem">
              </div>
              <div class="row form-group">
                <label><?php echo _('Correo Electrónico') ?></label>
                <input type="text" class="form-control" id="input_mail<?php echo $modal_item ?>" placeholder="<?php echo _('Correo Electrónico') ?>" value="Lorem">
              </div>
              <div class="row form-group">
                <label><?php echo _('Nueva contraseña') ?></label>
                <input type="text" class="form-control" id="input_pass<?php echo $modal_item ?>" placeholder="<?php echo _('Nueva contraseña') ?>" value="">
              </div>
            </div>
            <div class="col-xs-12 col-md-6">
              <div class="row form-group">
                <label><?php echo _('Nombre de usuario') ?></label>
                <input type="text" class="form-control" id="input_name<?php echo $modal_item ?>" placeholder="Nombre de usuario" value="">
              </div>
              <div class="row form-group">
                <label><?php echo _('Exclusión') ?></label>
              ...
              <div class="row form-group">
                <label><?php echo _('Nivel de ') . $modal_item ?></label>
          ...
          <div class="row form-group">
            <button type="submit" class="btn btn-sm btn-raised col-xs-12 col-md-5 right" style="margin-left:15px;"><?php echo _('Crear nuevo ') . $modal_item ?></button>
